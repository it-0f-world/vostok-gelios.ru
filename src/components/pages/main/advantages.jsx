        ...
        <div className={style.container}>
            ...
            <div className={style.content}>
                <div className={style.col}>
                    ...
                    <div className={style.colContent}>
                        <div className={style.header}>
                            <div className={style.icon}><FontAwesomeIcon icon={faAtom} /></div>
                    ...
                    <div className={style.colContent}>
                        <div className={style.header}>
                            <div className={style.icon}><FontAwesomeIcon icon={faMoneyBill1} /></div>
                ...
                <div className={style.col}>
                    <div className={style.colContent}>
                        <div className={style.header}>
                            <div className={style.icon}><FontAwesomeIcon icon={faBarcode} /></div>
                    ...
                    <div className={style.colContent}>
                        <div className={style.header}>
                            <div className={style.icon}><FontAwesomeIcon icon={faLeaf} /></div>
                    ...
                    <div className={style.colContent}>
                        <div className={style.header}>
                            <div className={style.icon}><FontAwesomeIcon icon={faRankingStar} /></div>
                            <h4>Надежность</h4>
                        </div>
                        <div style={{ backgroundColor: '#ff8c00', height: '4px', width: '33%', margin: '.5rem 0'}}></div>
